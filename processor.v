...
module processor(
	...
	wire is_bne, is_not_bne, is_store, is_not_jal, is_not_jr, is_jr, is_not_bex, is_setx;
	...
	is_ne isNotBEX(is_not_bex, q_imem[31:27], 5'b10110);
	...
	check_two isSETX(is_setx, q_imem[31:27], 5'b10101, q_imem[31:27], 5'b10101);
	...
	or is_REGB_RD(is_regb_rd, is_bne_blt, is_store, is_jr);
	 ...
	 wire[4:0] regB_in_tmp, regB_in;
	 mux_5bit rt_mux1 (regB_in_tmp, is_regb_rd, q_imem[16:12], q_imem[26:22] ); //checking for rd incase of store. 
	 mux_5bit rt_mux2 (regB_in, is_not_bex, 5'd30, regB_in_tmp ); //checking for rd incase of store.
	 ...
	 and reg_write_enable (ctrl_writeEnable, is_not_store, is_not_jtype, is_not_bne, is_not_blt, is_not_jr, is_not_bex); 
