...
add wave -noupdate /processor_tb/main_ctrl_writeReg
add wave -noupdate /processor_tb/main_data_writeReg
...
add wave -noupdate /processor_tb/s1/my_regfile/ctrl_writeReg
add wave -noupdate -expand -label {Contributors: ctrl_writeReg} -group {Contributors: sim:/processor_tb/s1/my_regfile/ctrl_writeReg} /processor_tb/s1/my_processor/checkingoverflow/in_reg
add wave -noupdate -expand -label {Contributors: ctrl_writeReg} -group {Contributors: sim:/processor_tb/s1/my_regfile/ctrl_writeReg} /processor_tb/s1/my_processor/checkingoverflow/w7
add wave -noupdate /processor_tb/s1/my_processor/checkingoverflow/w7
add wave -noupdate -expand -label {Contributors: w7} -group {Contributors: sim:/processor_tb/s1/my_processor/checkingoverflow/w7} /processor_tb/s1/my_processor/checkingoverflow/overflow
add wave -noupdate -expand -label {Contributors: w7} -group {Contributors: sim:/processor_tb/s1/my_processor/checkingoverflow/w7} /processor_tb/s1/my_processor/checkingoverflow/w6
add wave -noupdate /processor_tb/s1/my_processor/checkingoverflow/overflow
add wave -noupdate -expand -label {Contributors: overflow} -group {Contributors: sim:/processor_tb/s1/my_processor/checkingoverflow/overflow} /processor_tb/s1/my_processor/a1/inner_cout
add wave -noupdate -expand -label {Contributors: overflow} -group {Contributors: sim:/processor_tb/s1/my_processor/checkingoverflow/overflow} /processor_tb/s1/my_processor/a1/inner_result
add wave -noupdate /processor_tb/s1/my_processor/a1/inner_cout
add wave -noupdate -expand -label {Contributors: inner_cout} -group {Contributors: sim:/processor_tb/s1/my_processor/a1/inner_cout} /processor_tb/s1/my_processor/a1/ctrl_ALUopcode
add wave -noupdate -expand -label {Contributors: inner_cout} -group {Contributors: sim:/processor_tb/s1/my_processor/a1/inner_cout} /processor_tb/s1/my_processor/a1/ctrl_shiftamt
add wave -noupdate -expand -label {Contributors: inner_cout} -group {Contributors: sim:/processor_tb/s1/my_processor/a1/inner_cout} /processor_tb/s1/my_processor/a1/inner_A
add wave -noupdate -expand -label {Contributors: inner_cout} -group {Contributors: sim:/processor_tb/s1/my_processor/a1/inner_cout} /processor_tb/s1/my_processor/a1/inner_B
